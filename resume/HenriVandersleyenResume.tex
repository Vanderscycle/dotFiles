...
\personalinfo{%
  ...
  \homepage{home.vandersleyen.xyz}
...
\cvevent{CloudOps Engineer}{Knak}{Nov 2024 -- Ongoing}{Victoria, BC}
\begin{itemize}
Refactored entire legacy enterprise CICD pipelines; Migrated micro-services from
serverless to proper AWS CDK without client impact;
Integrated Athena into CDK and migrated TBs of data; Mentor junior engineers on AWS.
...
\cvevent{DevOps Engineer}{Operto Guest Technologies}{Jul 2023 -- Nov 2024}{Vancouver, BC}
\begin{itemize}
...
deployed several blockchain focused fullstack applications;
\end{itemize}
...
and ancillary systems, power generation, damage control, etc.
Advised the ship's captain on technical
...
\href{https://www.credly.com/badges/e700b2d0-dd6a-474c-bb99-25676eb2bf5b/linked_in_profile}{AWS Certified Solutions Architect – Associate}
...
\cvevent{DotFiles}{}{ongoing}{}
\begin{itemize}
\item Using Nix, I have replicable linux environments for my computer, homelabs, etc.
\item \faGithub Vanderscycle/dotFiles
\end{itemize}
...
\begin{itemize}
\item Simple SolidJs website hosted on AWS.
