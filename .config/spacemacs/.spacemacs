...
before packages are loaded."
  ;; IMPORTANT if you emacs config is mega doo doo and you don't know why check async-native-compile results
  ;; --- general ---
  ;; --- maggit ---
