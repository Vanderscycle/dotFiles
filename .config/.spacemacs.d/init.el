...
before packages are loaded."
  (setq opencode-host "192.168.2.153")
  (setq opencode-port 4096)

  (with-eval-after-load 'projectile
    (add-to-list 'projectile-project-root-files "app.config.ts");;solidstart
    )
  ...
  (autoload 'universal-launcher-popup "~/.config/hypr/scripts/template.el" nil t)
  )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-jump-helm-line ace-link ace-pinyin add-node-modules-path
         ...
         open-junk-file opencode org org-category-capture org-cliplink org-contrib
         ...
         rainbow-mode reformatter request restart-emacs rjsx-mode shell-pop shfmt
