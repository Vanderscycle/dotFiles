...
-- theme.confdir = os.getenv("HOME") .. "/.config/awesome/themes/" .. theme.name
theme.confdir = os.getenv("HOME") .. "/.config/awesome/themes/tokyonight-dark"
theme.wallpaper = theme.confdir .. "/switch.png"
theme.font = "JetBrains, Bold 10"
...
theme.iconfont = "JetBrains Nerd Font"
theme.iconfont_big = "JetBrans Nerd Font 11"
theme.taglist_font = "JetBrains Nerd Font 13"
...
theme.notification_font = "JetBrains Nerd Font 10"
...
theme.menu_bg_normal = "#1a1b26"
theme.menu_bg_focus = "#7aa2f7"
...
theme.tabbar_font = "JetBrains Nerd Font 10" -- font of the tabbar
