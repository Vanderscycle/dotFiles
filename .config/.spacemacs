...
before packages are loaded."
  ...
  (add-hook 'nix-mode-hook (lambda () (setq-local indent-tabs-mode nil) (setq-local tab-width 2)))
...
"
  ...
  (spacemacs/set-leader-keys "ot" 'hydra-tab-bar/body)  ;;; --- custom styling ---
  (custom-set-faces
