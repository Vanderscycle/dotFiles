...
_G.packer_plugins = {
  ...
  ["hop.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henri/.local/share/lunarvim/site/pack/packer/opt/hop.nvim",
  ...
  ["telescope-hop.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/henri/.local/share/lunarvim/site/pack/packer/opt/telescope-hop.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'telescope-hop.nvim', 'hop.nvim', 'telescope-fzy-native.nvim', 'lsp_signature.nvim', 'nvim-bqf', 'Comment.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
