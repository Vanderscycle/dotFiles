...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_signature.nvim', 'indent-blankline.nvim', 'nvim-bqf', 'gitsigns.nvim', 'lightspeed.nvim', 'Comment.nvim', 'todo-comments.nvim', 'telescope-fzy-native.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
