...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'todo-comments.nvim', 'telescope-fzy-native.nvim', 'indent-blankline.nvim', 'lsp_signature.nvim', 'Comment.nvim', 'nvim-bqf', 'hop.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
