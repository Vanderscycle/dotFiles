...
_G.packer_plugins = {
  ...
  ["FTerm.nvim"] = {
    loaded = true,
    path = "/home/henri/.local/share/lunarvim/site/pack/packer/start/FTerm.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'lsp_signature.nvim', 'Comment.nvim', 'nvim-bqf', 'telescope-fzy-native.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
