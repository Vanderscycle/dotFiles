...
_G.packer_plugins = {
  ...
  vimwiki = {
    commands = { "VimwikiIndex" },
    config = { "\27LJ\2\nÏ\1\0\0\3\0\5\0\v6\0\0\0009\0\1\0)\1\0\0=\1\2\0006\0\0\0009\0\1\0004\1\3\0005\2\4\0>\2\1\1=\1\3\0K\0\1\0\1\0\5\16auto_export\3\1\bext\b.md\vsyntax\rmarkdown\tpath#~/Documents/dotFiles/obsidian/\14path_html#~/Documents/dotFiles/obsidian/\17vimwiki_list\23vimwiki_global_ext\6g\bvim\0" },
    loaded = false,
    needs_bufread = true,
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Telescope lua require("packer.load")({'telescope.nvim', 'octo.nvim'}, { cmd = "Telescope", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'lspkind-nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
