...
_G.packer_plugins = {
  ...
  vimwiki = {
    commands = { "VimwikiIndex" },
    config = { "\27LJ\2\nœ\1\0\0\3\0\5\0\v6\0\0\0009\0\1\0)\1\0\0=\1\2\0006\0\0\0009\0\1\0004\1\3\0005\2\4\0>\2\1\1=\1\3\0K\0\1\0\1\0\5\bext\b.md\16auto_export\3\1\tpath#~/Documents/dotFiles/obsidian/\14path_html#~/Documents/dotFiles/obsidian/\vsyntax\rmarkdown\17vimwiki_list\23vimwiki_global_ext\6g\bvim\0" },
    loaded = false,
    needs_bufread = true,
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file VimwikiIndex lua require("packer.load")({'vimwiki', 'markdown-preview.nvim'}, { cmd = "VimwikiIndex", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-colorizer.lua', 'gitsigns.nvim', 'indent-blankline.nvim', 'lspkind-nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
