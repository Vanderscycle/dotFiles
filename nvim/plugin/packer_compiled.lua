...
_G.packer_plugins = {
  ...
  jester = {
    loaded = true,
    path = "/home/henri/.local/share/nvim/site/pack/packer/start/jester"
  },
  ["lightspeed.nvim"] = {
    loaded = true,
  ...
  ["markdown-preview.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/henri/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim"
  },
  neoformat = {
    commands = { "Neoformat" },
    loaded = false,
  ...
  ["nvim-comment"] = {
    ...
    config = { "\27LJ\2\nÖ\1\0\0\3\0\5\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\0\0'\2\3\0B\0\2\0029\0\4\0B\0\1\1K\0\1\0\25update_commentstring&ts_context_commentstring.internal\nsetup\17nvim_comment\frequire\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/home/henri/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils"
  },
  ["nvim-lspconfig"] = {
  ...
  ["octo.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/henri/.local/share/nvim/site/pack/packer/opt/octo.nvim"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ["telescope-dap.nvim"] = {
    loaded = true,
    path = "/home/henri/.local/share/nvim/site/pack/packer/start/telescope-dap.nvim"
  },
  ...
  vimwiki = {
    commands = { "VimwikiIndex" },
    config = { "\27LJ\2\nœ\1\0\0\3\0\5\0\v6\0\0\0009\0\1\0)\1\0\0=\1\2\0006\0\0\0009\0\1\0004\1\3\0005\2\4\0>\2\1\1=\1\3\0K\0\1\0\1\0\5\vsyntax\rmarkdown\tpath#~/Documents/dotFiles/obsidian/\bext\b.md\14path_html#~/Documents/dotFiles/obsidian/\16auto_export\3\1\17vimwiki_list\23vimwiki_global_ext\6g\bvim\0" },
    loaded = false,
    needs_bufread = true,
...
try_loadstring("\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15bufferline\frequire\0", "config", "nvim-bufferline.lua")
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file VimwikiIndex lua require("packer.load")({'markdown-preview.nvim', 'vimwiki'}, { cmd = "VimwikiIndex", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Telescope lua require("packer.load")({'octo.nvim', 'telescope.nvim'}, { cmd = "Telescope", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'gitsigns.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
