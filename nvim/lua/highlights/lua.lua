...
local white = colors.BASE04
local darker_black = "#1b1f27"
local black = "#1e222a"
local black2 = "#252931"
local one_bg = colors.BASE01
local one_bg2 = colors.BASE02
local one_bg3 = colors.BASE03
local light_grey = "#6f737b"
local grey = "#42464e"
local grey_fg = "#565c64"
local red = colors.BASE0b
local line = colors.BASE05
local green = colors.BASE0e
local nord_blue = colors.BASE09
local blue = colors.BASE0a
local yellow = colors.BASE0d
local purple = colors.BASE0f
