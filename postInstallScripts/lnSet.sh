...
declare -a StringArray=(".xinitrc"  ".gitconfig"".tmux.conf"  ".gpg/gpg-agent" ".ripgreprc" ".condarc")
...
declare -a ConfArray=("lvim" "broot" "tmuxinator" "zellij" "tmux" "kitty" "xmobar" "dunst" "fontconfig" "rg" "qutebrowser" "mimeapps.list" "bat" "rg" "neofetch")
