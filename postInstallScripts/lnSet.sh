...
declare -a StringArray=(".xinitrc"  ".gitconfig" ".gitconfig.personal" ".gpg/gpg-agent" ".ripgreprc" ".vale.ini" )
...
declare -a ConfArray=("lvim" "broot" "zellij" "kitty" "xmobar" "dunst" "fontconfig" "rg" "mimeapps.list" "bat" "rg" "neofetch" "picom" "k9s")
